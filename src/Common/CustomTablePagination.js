...
// Custom pagination with manual control over navigations
function CustomTablePagination(props) {
  const classes = useStyles1();
  const theme = useTheme();
  const { count, page, rowsPerPage, onChangePage } = props;

  // handler to move to First page
  ...
  return (
    <div className={classes.root}>
      ...
      <IconButton onClick={moveToPreviousPage} disabled={page === 0} aria-label="previous page">
